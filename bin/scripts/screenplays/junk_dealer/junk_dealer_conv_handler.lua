...
function JunkDealerConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif string.find(screenID, "give_") ~= nil then
		...
		if pInventory == nil or SceneObject(pInventory):isContainerFullRecursive() then
			...
			elseif screenID == "give_civilian_barc" then
				kitTemplate = "object/tangible/loot/collectible/kits/civilian_barc_speeder_kit.iff"
			elseif screenID == "give_snowspeeder" then
				kitTemplate = "object/tangible/loot/collectible/kits/snowspeeder_kit.iff"
			end
