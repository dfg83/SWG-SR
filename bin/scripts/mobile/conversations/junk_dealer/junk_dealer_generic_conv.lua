...
inventor = ConvoScreen:new {
	...
	options = {
		...
		{"@conversation/junk_dealer_generic2:kit_types", "kit_types"}, -- I know those kits, what types do you have?
	}
}
...
--	leftDialog = "@conversation/junk_dealer_generic:s_3fc7eb45", -- Well let's see here. I have one that makes an orange rug, one that makes a blue rug, one that can make a Nabooian sculpture, one that makes a table, and one that make some sort of model gong. I will only give you one kit at a time so if you want another you are going to have to get rid of the one you currently have first.
	...
	options = {
		...
		{"@conversation/junk_dealer_generic2:give_civilian_barc", "give_civilian_barc"}, -- I think I will try out the one that makes the Civilian BARC Speeder.
		{"@conversation/junk_dealer_generic2:give_snowspeeder", "give_snowspeeder"}, -- The Snowspeeder sounds exciting, I'll take that kit please
	}
}
...
give_civilian_barc = ConvoScreen:new {
	id = "give_civilian_barc",
	leftDialog = "@conversation/junk_dealer_generic2:give_civilian_barc_info", -- Ok, here you go. I guess in order to make it work you need to add six special components to the kit. When you examine a kit, it has a list of what you need in order to complete the kit. It also has a read-out of whether it currently has a component or not. I believe the components are rewards for completing various racetracks around the Galaxy.
	stopConversation = "true",
	options = {}
}
junkDealerGenericConvoTemplate:addScreen(give_civilian_barc);

give_snowspeeder = ConvoScreen:new {
	id = "give_snowspeeder",
	leftDialog = "@conversation/junk_dealer_generic2:give_snowspeeder_info", -- Ok, here you go. I guess in order to make it work you need to add eight special components to the kit. When you examine a kit, it has a list of what you need in order to complete the kit. It also has a read-out of whether it currently has a component or not. I believe the components are rewards for completing various racetracks around the Galaxy.
	stopConversation = "true",
	options = {}
}
junkDealerGenericConvoTemplate:addScreen(give_snowspeeder);
