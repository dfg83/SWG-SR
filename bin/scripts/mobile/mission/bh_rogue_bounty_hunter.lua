bh_rogue_bounty_hunter = Creature:new {
	customName = "Rogue Bounty Hunter",
	...
	baseHAMmax = 96000,
	armor = 2,
	resists = {155,125,85,60,180,50,70,15,-1},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
	...
	lootGroups = {
		...
		{
			groups = {
				{group = "g_statted_bh_helmet", chance = 10000000},
			},
			lootChance = 1000000
		},
	},
	weapons = {"light_lightning_cannon"},
...
CreatureTemplates:addCreatureTemplate(bh_rogue_bounty_hunter, "bh_rogue_bounty_hunter")
