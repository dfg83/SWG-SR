...
---------------------------------------------------------------------------------------------------------------
object_tangible_loot_collectible_kits_shared_civilian_barc_speeder_kit = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/loot/collectible/kits/shared_civilian_barc_speeder_kit.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_loot_collectible_kits_shared_civilian_barc_speeder_kit, "object/tangible/loot/collectible/kits/shared_civilian_barc_speeder_kit.iff")

---------------------------------------------------------------------------------------------------------------
object_tangible_loot_collectible_kits_shared_snowspeeder_kit = SharedTangibleObjectTemplate:new {
	clientTemplateFileName = "object/tangible/loot/collectible/kits/shared_snowspeeder_kit.iff"
}

ObjectTemplates:addClientTemplate(object_tangible_loot_collectible_kits_shared_snowspeeder_kit, "object/tangible/loot/collectible/kits/shared_snowspeeder_kit.iff")
