...
void TemplateManager::registerTemplateObjects() {
	...
	templateFactory.registerObject<FamiliarPetDeedTemplate>(SharedObjectTemplate::FAMILIARPETDEED);
	...
	templateFactory.registerObject<DataDiskTemplate>(SharedObjectTemplate::DATADISK);
...
void TemplateManager::registerGlobals() {
	...
	luaTemplatesInstance->setGlobalInt("FAMILIARPETDEED", SharedObjectTemplate::FAMILIARPETDEED);
	...
	luaTemplatesInstance->setGlobalInt("DATADISK", SharedObjectTemplate::DATADISK);
